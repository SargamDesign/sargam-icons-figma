...
const iconsPkg = require('./node_modules/sargam-icons/package.json')
...
const generateIconsJSON = (jsonFile, filename) => {
	...
	for (let iconName in files) {
		...
		svgList.push({
			...
			svg: prepareSvgFile(fs.readFileSync(`./node_modules/sargam-icons/icons/Line/${iconName}.svg`).toString())
		})
	}
...
// generateIconsJSON('./node_modules/sargam-icons/icons/tags.json', `./src/icons.json`)
